...
class _OrderTrackingScreenState extends ConsumerState<OrderTrackingScreen> {
            ...
            StitchTopAppBar(
              ...
              navLinks: isDesktop
                  ? [
                      ...
                      const NavLink('Pedidos', true, route: '/orders/tracking'),
                      ...
                      if (RouteGuard.canAccessPayment(currentUser, permissions))
                        const NavLink('Caja', false, route: '/cashier/pending'),
  ...
  Widget _buildOrderGrid(
    bool isDesktop,
    AsyncValue<List<Order>> activeOrdersAsync,
        ...
        return GridView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            final items = order.items.map((item) {
              ...
              return {
                'name': '${item.quantity}x ${item.name ?? menuItem.name}',
                'price':
              ...
              actions: [
                if (order.status == OrderStatus.sentToKitchen ||
                  ...
                  _buildActionBtn(
                    ...
                    Icons.edit,
                    false,
                    onTap: () => context.go('/orders/${order.id}/edit'),
                  ),
                if (order.status == OrderStatus.sentToKitchen)
                  _buildActionBtn(
                    'Cancelar',
                  ...
                  _buildActionBtn(
                    ...
                    onTap: () => ref
                        ...
                        .updateStatus(
                          ...
                          byUserId:
                              ref.read(currentUserProvider).value?.id ?? 'user',
                        ),
                  ),
                if (order.status == OrderStatus.billed &&
                    (currentUser?.role == Role.cajero ||
  ...
  Widget _buildActionBtn(
    ...
    return ElevatedButton(
      onPressed: onTap ?? () {},
      style: ElevatedButton.styleFrom(
        backgroundColor: isPrimary ? AppColors.primaryContainer : Colors.white,
      ...
      child: FittedBox(
        ...
        child: Row(
          ...
          children: [
            ...
            Text(
              text,
              style: AppTypography.statusBadge(fontWeight: FontWeight.bold),
            ),
          ],
        ),
      ),
